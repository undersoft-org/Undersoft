...
public static class ViewGraphic
{
    ...
    {
        public sealed class HeaderMono : Icon
        {
            public HeaderMono()
                : base(
                    "Undersoft",
        ...
        public sealed class HeaderColor : Icon
        {
            public HeaderColor()
                : base(
                    "Undersoft",
        ...
        public sealed class Benchmarks : Icon
        {
            public Benchmarks()
                : base(
                    ...
                    IconVariant.Regular,
                    IconSize.Custom,
                    @"<svg width=""300"" height=""45"" version=""1.1"" viewBox=""0 0 79.377 11.906"" xmlns=""http://www.w3.org/2000/svg"">
