...
public class RemoteInvokedHandler<TStore, TService, TModel>
    : INotificationHandler<RemoteInvoked<TStore, TService, TModel>>
    ...
    where TStore : IDataServiceStore
{
    ...
    public virtual Task Handle(
        RemoteInvoked<TStore, TService, TModel> request,
