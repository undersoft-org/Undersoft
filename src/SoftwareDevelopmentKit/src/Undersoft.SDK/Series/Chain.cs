...
public class Chain<V> : ChainBase<V>
{
    ...
    public Chain(IList<ISeriesItem<V>> collection, int capacity = 9, HashBits bits = HashBits.bit64)
    ...
    public Chain(int capacity = 9, HashBits bits = HashBits.bit64) : base(capacity, bits) { }
