...
public partial class Repository<TEntity>
{
    ...
    {
        return QueryMapTo<TDto>(this[expanders]);
    }
    ...
    {
        return QueryMapTo<TDto>(this[sortTerms, expanders]);
    }
    ...
    {
        return QueryMapAsyncTo<TDto>(this[expanders]);
    }
    ...
    {
        return QueryMapAsyncTo<TDto>(this[sortTerms, expanders]);
    }
    ...
    {
        return QueryMapAsyncTo<TDto>(this[predicate, sortTerms, expanders]);
    }
