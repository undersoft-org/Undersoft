...
public abstract partial class Repository<TEntity> : IRepositoryIndexer<TEntity> where TEntity : class, IOrigin, IInnerProxy
{
    ...
    public virtual object this[bool reverse, Expression<Func<TEntity, object>> selector, Expression<
        Func<TEntity, object>
    >[] expanders] =>
        (reverse)
    ...
    public virtual object this[bool reverse, Expression<Func<TEntity, object>> selector, Expression<
        Func<TEntity, bool>
    > predicate, SortExpression<TEntity> sortTerms, params Expression<
        Func<TEntity, object>
    >[] expanders] =>
        (reverse)
    ...
    public virtual TEntity this[bool reverse, Expression<
        Func<TEntity, bool>
    ...
    public virtual TEntity this[bool reverse, SortExpression<TEntity> sortTerms, params Expression<
        Func<TEntity, object>
    >[] expanders] =>
        (reverse)
    ...
    public virtual IList<object> this[int skip, int take, Expression<
        Func<TEntity, object>
    > selector, Expression<Func<TEntity, object>>[] expanders] =>
        (take > 0)
    ...
    public virtual IList<object> this[int skip, int take, Expression<
        Func<TEntity, object>
    > selector, Expression<Func<TEntity, bool>> predicate, params Expression<
        Func<TEntity, object>
    >[] expanders] =>
        (take > 0)
    ...
    public virtual IQueryable<TEntity> this[IQueryable<TEntity> query, Expression<
        Func<TEntity, bool>
    > predicate] => query.Where(predicate).AsQueryable();

    public virtual IQueryable<object> this[IQueryable<TEntity> query, Expression<
        Func<TEntity, object>
    ...
    public virtual IQueryable<TEntity> this[Expression<
        Func<TEntity, object>
    > selector, IEnumerable<object> values] => Query.WhereIn(selector, values);

    public virtual IQueryable<TEntity> this[Expression<
        Func<TEntity, object>
    > selector, IEnumerable<object> values, params Expression<Func<TEntity, object>>[] expanders] =>
        this[this[expanders], selector, values];

    public virtual IQueryable<object> this[Expression<Func<TEntity, object>> selector, Expression<
        Func<TEntity, object>
    >[] expanders] => this[this[expanders], selector];
    ...
    > predicate, SortExpression<TEntity> sortTerms, params Expression<
        Func<TEntity, object>
    >[] expanders] => this[Sort(this[predicate, expanders], sortTerms), selector];

    public virtual IQueryable<object> this[Expression<Func<TEntity, object>> selector, Expression<
        Func<TEntity, bool>
    > predicate] => this[this[predicate], selector];

    public virtual IQueryable<TEntity> this[Expression<
        Func<TEntity, bool>
    > predicate, SortExpression<TEntity> sortTerms] => Sort(this[predicate], sortTerms);
    ...
    public virtual IQueryable<TEntity> this[SortExpression<TEntity> sortTerms, Expression<
        Func<TEntity, object>
    >[] expanders] => Sort(this[expanders], sortTerms);
