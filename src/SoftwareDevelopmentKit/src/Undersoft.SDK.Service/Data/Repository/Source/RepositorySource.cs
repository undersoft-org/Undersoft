...
public class RepositorySource : Registry<IRepositoryContext>, IRepositorySource
{
    ...
    public RepositorySource(StoreProvider provider, string connectionString) : this()
    {
        ContextPool = this;
        optionsBuilder = StoreSourceOptionsBuilder.BuildOptions(provider, connectionString);
    ...
    public virtual IRepositoryContext Rent()
    {
        ...
        return (IRepositoryContext)
            typeof(IRepositorySource<>).MakeGenericType(ContextType).New(this);
    }
