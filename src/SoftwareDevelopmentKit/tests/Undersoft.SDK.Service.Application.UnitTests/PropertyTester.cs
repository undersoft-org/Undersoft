namespace Undersoft.SDK.Service.Application.UnitTests
{
    using System;
    ...
    public static class PropertyTester
    {
            ...
            where TContainer : INotifyPropertyChanged
        {
            ...
            Assert.AreEqual(getMethod.Invoke(propertyContainer, new object[] { }), value1);

            setMethod.Invoke(propertyContainer, new object[] { value2 });
            Assert.IsTrue(propertyChanged);

            Assert.AreEqual(getMethod.Invoke(propertyContainer, new object[] { }), value2);
