...
public partial class ServerSetupTests
{
    ...
    /// <summary>
    /// Checks that the AddServerSetupRemoteInvocationImplementations method functions correctly.
    /// </summary>
    [TestMethod]
    public void CanCallAddServerSetupRemoteInvocationImplementations()
    {
        // Act
        var result = this._testClass.AddServerSetupRemoteInvocationImplementations();
