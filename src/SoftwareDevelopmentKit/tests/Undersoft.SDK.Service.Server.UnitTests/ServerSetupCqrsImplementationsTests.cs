...
public partial class ServerSetupTests
{
    ...
    /// <summary>
    /// Checks that the AddServerSetupCqrsImplementations method functions correctly.
    /// </summary>
    [TestMethod]
    public void CanCallAddServerSetupCqrsImplementations()
    {
        // Act
        var result = this._testClass.AddServerSetupCqrsImplementations();
