...
public partial class ServerSetupTests
{
    ...
    /// <summary>
    /// Checks that the AddServerSetupRemoteCqrsImplementations method functions correctly.
    /// </summary>
    [TestMethod]
    public void CanCallAddServerSetupRemoteCqrsImplementations()
    {
        // Act
        var result = this._testClass.AddServerSetupRemoteCqrsImplementations();
