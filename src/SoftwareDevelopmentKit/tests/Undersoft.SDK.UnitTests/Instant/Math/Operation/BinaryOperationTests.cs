...
/// <summary>
/// Unit tests for the type <see cref="BinaryOperation"/>.
/// </summary>
public class BinaryOperationTests
{
    private BinaryOperation _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="BinaryOperation"/>.
    /// </summary>
    public BinaryOperationTests()
    {
        ...
        this._testClass = _fixture.Create<BinaryOperation>();
    }
    ...
    {
        // Act
        var instance = new BinaryOperation(this._e1, this._e2, this._op);
    ...
    {
        FluentActions.Invoking(() => new BinaryOperation(default(Formula), this._e2, this._op)).Should().Throw<ArgumentNullException>().WithParameterName("e1");
    }
    ...
    {
        FluentActions.Invoking(() => new BinaryOperation(this._e1, default(Formula), this._op)).Should().Throw<ArgumentNullException>().WithParameterName("e2");
    }
    ...
    {
        FluentActions.Invoking(() => new BinaryOperation(this._e1, this._e2, default(BinaryOperator))).Should().Throw<ArgumentNullException>().WithParameterName("op");
    }
