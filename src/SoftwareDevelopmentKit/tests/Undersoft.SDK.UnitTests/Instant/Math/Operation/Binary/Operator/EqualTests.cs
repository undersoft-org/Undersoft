...
/// <summary>
/// Unit tests for the type <see cref="Equal"/>.
/// </summary>
public class EqualTests
{
    private Equal _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Equal"/>.
    /// </summary>
    public EqualTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Equal>();
    }
