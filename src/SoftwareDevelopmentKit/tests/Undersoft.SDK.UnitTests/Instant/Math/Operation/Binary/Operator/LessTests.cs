...
/// <summary>
/// Unit tests for the type <see cref="Less"/>.
/// </summary>
public class LessTests
{
    private Less _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Less"/>.
    /// </summary>
    public LessTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Less>();
    }
