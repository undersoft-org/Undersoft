...
/// <summary>
/// Unit tests for the type <see cref="OrOperand"/>.
/// </summary>
public class OrOperandTests
{
    private OrOperand _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="OrOperand"/>.
    /// </summary>
    public OrOperandTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<OrOperand>();
    }
