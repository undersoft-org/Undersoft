...
/// <summary>
/// Unit tests for the type <see cref="Minus"/>.
/// </summary>
public class MinusTests
{
    private Minus _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Minus"/>.
    /// </summary>
    public MinusTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Minus>();
    }
