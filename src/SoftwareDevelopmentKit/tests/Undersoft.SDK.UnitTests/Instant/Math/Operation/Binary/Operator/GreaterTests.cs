...
/// <summary>
/// Unit tests for the type <see cref="Greater"/>.
/// </summary>
public class GreaterTests
{
    private Greater _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Greater"/>.
    /// </summary>
    public GreaterTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Greater>();
    }
