...
/// <summary>
/// Unit tests for the type <see cref="Divide"/>.
/// </summary>
public class DivideTests
{
    private Divide _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Divide"/>.
    /// </summary>
    public DivideTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Divide>();
    }
