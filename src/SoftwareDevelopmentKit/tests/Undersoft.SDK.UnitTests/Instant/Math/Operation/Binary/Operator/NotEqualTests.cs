...
/// <summary>
/// Unit tests for the type <see cref="NotEqual"/>.
/// </summary>
public class NotEqualTests
{
    private NotEqual _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="NotEqual"/>.
    /// </summary>
    public NotEqualTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<NotEqual>();
    }
