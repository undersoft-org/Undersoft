...
/// <summary>
/// Unit tests for the type <see cref="AndOperand"/>.
/// </summary>
public class AndOperandTests
{
    private AndOperand _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="AndOperand"/>.
    /// </summary>
    public AndOperandTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<AndOperand>();
    }
