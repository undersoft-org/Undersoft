...
/// <summary>
/// Unit tests for the type <see cref="Multiply"/>.
/// </summary>
public class MultiplyTests
{
    private Multiply _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Multiply"/>.
    /// </summary>
    public MultiplyTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<Multiply>();
    }
