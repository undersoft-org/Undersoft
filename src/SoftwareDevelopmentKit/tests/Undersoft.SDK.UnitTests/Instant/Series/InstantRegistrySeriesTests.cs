...
/// <summary>
/// Unit tests for the type <see cref="InstantRegistrySeries"/>.
/// </summary>
public class InstantRegistrySeriesTests
{
    private class TestInstantRegistrySeries : InstantRegistrySeries
    {
    ...
    private TestInstantRegistrySeries _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="InstantRegistrySeries"/>.
    /// </summary>
    public InstantRegistrySeriesTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<TestInstantRegistrySeries>();
    }
    ...
    /// </summary>
    [TestMethod]
    public void CanCallSerializeWithBufferAndOffsetAndBatchSize()
    {
        // Arrange
        ...
        // Act
        var result = this._testClass.Serialize(buffer, offset, batchSize
        );
    ...
    /// <summary>
    /// Checks that the Serialize method throws when the buffer parameter is null.
    /// </summary>
    [TestMethod]
    public void CannotCallSerializeWithBufferAndOffsetAndBatchSizeWithNullBuffer()
    {
        FluentActions.Invoking(() => this._testClass.Serialize(default(byte[]), _fixture.Create<int>(), _fixture.Create<int>())).Should().Throw<ArgumentNullException>().WithParameterName("buffer");
    }
