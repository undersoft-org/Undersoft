...
/// <summary>
/// Unit tests for the type <see cref="InstantCompilerValueTypes"/>.
/// </summary>
public class InstantCompilerValueTypesTests
{
    private InstantCompilerValueTypes _testClass;
    private IFixture _fixture;
    private InstantCreator _instantInstantCreator;
    private Mock<ISeries<RubricModel>> _rubricBuilders;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="InstantCompilerValueTypes"/>.
    /// </summary>
    public InstantCompilerValueTypesTests()
    {
        ...
        this._testClass = _fixture.Create<InstantCompilerValueTypes>();
    }
    ...
    {
        // Act
        var instance = new InstantCompilerValueTypes(this._instantInstantCreator, this._rubricBuilders.Object);
    ...
    {
        FluentActions.Invoking(() => new InstantCompilerValueTypes(default(InstantCreator), this._rubricBuilders.Object)).Should().Throw<ArgumentNullException>().WithParameterName("instantInstantCreator");
    }
    ...
    {
        FluentActions.Invoking(() => new InstantCompilerValueTypes(this._instantInstantCreator, default(ISeries<RubricModel>))).Should().Throw<ArgumentNullException>().WithParameterName("rubricBuilders");
    }
