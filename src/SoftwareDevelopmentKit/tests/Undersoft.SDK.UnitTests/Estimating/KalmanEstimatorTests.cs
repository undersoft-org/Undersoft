...
/// <summary>
/// Unit tests for the type <see cref="KalmanEstimator"/>.
/// </summary>
public class KalmanEstimatorTests
{
    private KalmanEstimator _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="KalmanEstimator"/>.
    /// </summary>
    public KalmanEstimatorTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<KalmanEstimator>();
    }
