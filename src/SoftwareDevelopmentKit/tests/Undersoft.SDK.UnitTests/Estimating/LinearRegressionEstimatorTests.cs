...
/// <summary>
/// Unit tests for the type <see cref="LinearRegressionEstimator"/>.
/// </summary>
public class LinearRegressionEstimatorTests
{
    private LinearRegressionEstimator _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="LinearRegressionEstimator"/>.
    /// </summary>
    public LinearRegressionEstimatorTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<LinearRegressionEstimator>();
    }
