...
/// <summary>
/// Unit tests for the type <see cref="LinearLastSquareEstimator"/>.
/// </summary>
public class LinearLastSquareEstimatorTests
{
    private LinearLastSquareEstimator _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="LinearLastSquareEstimator"/>.
    /// </summary>
    public LinearLastSquareEstimatorTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<LinearLastSquareEstimator>();
    }
