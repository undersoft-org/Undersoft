...
/// <summary>
/// Unit tests for the type <see cref="RecursiveLeastSquareEstimator"/>.
/// </summary>
public class RecursiveLeastSquareEstimatorTests
{
    private RecursiveLeastSquareEstimator _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="RecursiveLeastSquareEstimator"/>.
    /// </summary>
    public RecursiveLeastSquareEstimatorTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<RecursiveLeastSquareEstimator>();
    }
