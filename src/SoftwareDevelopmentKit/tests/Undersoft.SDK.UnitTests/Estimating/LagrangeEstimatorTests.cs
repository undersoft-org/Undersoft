...
/// <summary>
/// Unit tests for the type <see cref="LagrangeEstimator"/>.
/// </summary>
public class LagrangeEstimatorTests
{
    private LagrangeEstimator _testClass;
    private IFixture _fixture;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="LagrangeEstimator"/>.
    /// </summary>
    public LagrangeEstimatorTests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._testClass = _fixture.Create<LagrangeEstimator>();
    }
