...
/// <summary>
/// Unit tests for the type <see cref="Registry64"/>.
/// </summary>
public class Registry64_1Tests
{
    private Registry64<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Registry64"/>.
    /// </summary>
    public Registry64_1Tests()
    {
        ...
        this._testClass = _fixture.Create<Registry64<V>>();
    }
    ...
    {
        // Act
        var instance = new Registry64<V>(this._collectionIEnumerableV, this._capacity);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new Registry64<V>(this._collectionIListV, this._capacity);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new Registry64<V>(this._capacity);
    ...
    {
        FluentActions.Invoking(() => new Registry64<V>(default(IEnumerable<V>), this._capacity)).Should().Throw<ArgumentNullException>().WithParameterName("collection");
        FluentActions.Invoking(() => new Registry64<V>(default(IList<V>), this._capacity)).Should().Throw<ArgumentNullException>().WithParameterName("collection");
    }
