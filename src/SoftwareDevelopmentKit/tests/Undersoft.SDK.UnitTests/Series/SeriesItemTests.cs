...
/// <summary>
/// Unit tests for the type <see cref="SeriesItem"/>.
/// </summary>
public class SeriesItem_1Tests
{
    private SeriesItem<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="SeriesItem"/>.
    /// </summary>
    public SeriesItem_1Tests()
    {
        ...
        this._testClass = _fixture.Create<SeriesItem<V>>();
    }
    ...
    {
        // Act
        var instance = new SeriesItem<V>();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem<V>(this._valueISeriesItemV.Object);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem<V>(this._keyObject, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem<V>(this._keyInt64, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem<V>(this._valueUnknownType);
    ...
    {
        FluentActions.Invoking(() => new SeriesItem<V>(default(ISeriesItem<V>))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem<V>(this._keyObject, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem<V>(this._keyInt64, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem<V>(default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
    ...
    {
        FluentActions.Invoking(() => new SeriesItem<V>(default(object), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
        FluentActions.Invoking(() => new SeriesItem<V>(default(long), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
    }
