...
/// <summary>
/// Unit tests for the type <see cref="Listing"/>.
/// </summary>
public class Listing_1Tests
{
    private Listing<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="Listing"/>.
    /// </summary>
    public Listing_1Tests()
    {
        ...
        this._testClass = _fixture.Create<Listing<V>>();
    }
    ...
    {
        // Act
        var instance = new Listing<V>();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new Listing<V>(this._collection, this._capacity, this._repeatable);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new Listing<V>(this._repeatable, this._capacity);
    ...
    {
        FluentActions.Invoking(() => new Listing<V>(default(IEnumerable<V>), this._capacity, this._repeatable)).Should().Throw<ArgumentNullException>().WithParameterName("collection");
    }
