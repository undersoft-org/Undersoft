...
/// <summary>
/// Unit tests for the type <see cref="TracedSeriesItem"/>.
/// </summary>
public class TracedSeriesItem_1Tests
{
    private TracedSeriesItem<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="TracedSeriesItem"/>.
    /// </summary>
    public TracedSeriesItem_1Tests()
    {
        ...
        this._testClass = _fixture.Create<TracedSeriesItem<V>>();
    }
    ...
    {
        // Act
        var instance = new TracedSeriesItem<V>();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TracedSeriesItem<V>(this._valueISeriesItemV.Object);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TracedSeriesItem<V>(this._keyObject, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TracedSeriesItem<V>(this._keyInt64, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TracedSeriesItem<V>(this._valueUnknownType);
    ...
    {
        FluentActions.Invoking(() => new TracedSeriesItem<V>(default(ISeriesItem<V>))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TracedSeriesItem<V>(this._keyObject, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TracedSeriesItem<V>(this._keyInt64, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TracedSeriesItem<V>(default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
    ...
    {
        FluentActions.Invoking(() => new TracedSeriesItem<V>(default(object), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
        FluentActions.Invoking(() => new TracedSeriesItem<V>(default(long), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
    }
    ...
    {
        FluentActions.Invoking(() => this._testClass.Set(_fixture.Create<object>(), default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
    ...
    {
        FluentActions.Invoking(() => this._testClass.Set(default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
