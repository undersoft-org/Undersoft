...
/// <summary>
/// Unit tests for the type <see cref="CatalogBase"/>.
/// </summary>
public class CatalogBase_1Tests
{
    private class TestCatalogBase : CatalogBase<V>
    {
        public TestCatalogBase() : base()
        {
        }

        public TestCatalogBase(int capacity = 17, HashBits bits = HashBits.bit64) : base(capacity, bits)
        {
        }

        public TestCatalogBase(
        ...
        public TestCatalogBase(IList<V> collection, int capacity = 17, HashBits bits = HashBits.bit64) : base(collection, capacity, bits)
        {
        }
    ...
    private TestCatalogBase _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="CatalogBase"/>.
    /// </summary>
    public CatalogBase_1Tests()
    {
        ...
        this._testClass = _fixture.Create<TestCatalogBase>();
    }
    ...
    {
        // Act
        var instance = new TestCatalogBase();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TestCatalogBase(this._capacity, this._bits);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TestCatalogBase(this._collectionIEnumerableV, this._capacity, this._bits);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TestCatalogBase(this._collectionIListV, this._capacity, this._bits);
    ...
    {
        FluentActions.Invoking(() => new TestCatalogBase(default(IEnumerable<V>), this._capacity, this._bits)).Should().Throw<ArgumentNullException>().WithParameterName("collection");
        FluentActions.Invoking(() => new TestCatalogBase(default(IList<V>), this._capacity, this._bits)).Should().Throw<ArgumentNullException>().WithParameterName("collection");
    }
