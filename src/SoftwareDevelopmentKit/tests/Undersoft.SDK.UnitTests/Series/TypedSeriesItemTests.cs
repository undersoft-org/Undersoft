...
/// <summary>
/// Unit tests for the type <see cref="TypedSeriesItem"/>.
/// </summary>
public class TypedSeriesItem_1Tests
{
    private TypedSeriesItem<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="TypedSeriesItem"/>.
    /// </summary>
    public TypedSeriesItem_1Tests()
    {
        ...
        this._testClass = _fixture.Create<TypedSeriesItem<V>>();
    }
    ...
    {
        // Act
        var instance = new TypedSeriesItem<V>();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TypedSeriesItem<V>(this._valueISeriesItemV.Object);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TypedSeriesItem<V>(this._keyObject, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TypedSeriesItem<V>(this._keyUInt64, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new TypedSeriesItem<V>(this._valueUnknownType);
    ...
    {
        FluentActions.Invoking(() => new TypedSeriesItem<V>(default(ISeriesItem<V>))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TypedSeriesItem<V>(this._keyObject, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TypedSeriesItem<V>(this._keyUInt64, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new TypedSeriesItem<V>(default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
    ...
    {
        FluentActions.Invoking(() => new TypedSeriesItem<V>(default(object), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
        FluentActions.Invoking(() => new TypedSeriesItem<V>(default(ulong), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
    }
