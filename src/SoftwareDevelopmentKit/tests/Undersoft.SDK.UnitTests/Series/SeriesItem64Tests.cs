...
/// <summary>
/// Unit tests for the type <see cref="SeriesItem64"/>.
/// </summary>
public class SeriesItem64_1Tests
{
    private SeriesItem64<V> _testClass;
    ...
    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="SeriesItem64"/>.
    /// </summary>
    public SeriesItem64_1Tests()
    {
        ...
        this._testClass = _fixture.Create<SeriesItem64<V>>();
    }
    ...
    {
        // Act
        var instance = new SeriesItem64<V>();

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem64<V>(this._valueISeriesItemV.Object);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem64<V>(this._keyObject, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem64<V>(this._keyInt64, this._valueUnknownType);

        // Assert
        instance.Should().NotBeNull();

        // Act
        instance = new SeriesItem64<V>(this._valueUnknownType);
    ...
    {
        FluentActions.Invoking(() => new SeriesItem64<V>(default(ISeriesItem<V>))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem64<V>(this._keyObject, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem64<V>(this._keyInt64, default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
        FluentActions.Invoking(() => new SeriesItem64<V>(default(V))).Should().Throw<ArgumentNullException>().WithParameterName("value");
    }
    ...
    {
        FluentActions.Invoking(() => new SeriesItem64<V>(default(object), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
        FluentActions.Invoking(() => new SeriesItem64<V>(default(long), this._valueUnknownType)).Should().Throw<ArgumentNullException>().WithParameterName("key");
    }
