...
/// <summary>
/// Unit tests for the type <see cref="RemoteCommandSetValidatorBase"/>.
/// </summary>
public class RemoteCommandSetValidatorBase_1Tests
{
    private class TestRemoteCommandSetValidatorBase : RemoteCommandSetValidatorBase<TCommand>
    {
        public TestRemoteCommandSetValidatorBase(IServicer servicer) : base(servicer)
        {
        }
    ...
    private TestRemoteCommandSetValidatorBase _testClass;
    private IFixture _fixture;
    private Mock<IServicer> _servicer;

    /// <summary>
    /// Sets up the dependencies required for the tests for <see cref="RemoteCommandSetValidatorBase"/>.
    /// </summary>
    public RemoteCommandSetValidatorBase_1Tests()
    {
        _fixture = new Fixture().Customize(new AutoMoqCustomization());
        this._servicer = _fixture.Freeze<Mock<IServicer>>();
        this._testClass = _fixture.Create<TestRemoteCommandSetValidatorBase>();
    }
    ...
    {
        FluentActions.Invoking(() => new TestRemoteCommandSetValidatorBase(default(IServicer))).Should().Throw<ArgumentNullException>().WithParameterName("servicer");
    }
