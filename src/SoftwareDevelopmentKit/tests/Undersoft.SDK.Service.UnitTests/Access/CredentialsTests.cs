...
public class CredentialsTests
{
    ...
    public CredentialsTests()
    {
        ...
        this._testClass = _fixture.Create<Credentials>();
    }
    ...
    {
        this._testClass.CheckProperty(x => x.Site, _fixture.Create<ServiceSite?>(), _fixture.Create<ServiceSite?>());
    }
    ...
    {
        this._testClass.CheckProperty(x => x.Type, _fixture.Create<IdentityType?>(), _fixture.Create<IdentityType?>());
    }
