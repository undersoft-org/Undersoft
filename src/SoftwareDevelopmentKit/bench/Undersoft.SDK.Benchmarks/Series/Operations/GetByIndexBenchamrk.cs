...
namespace Undersoft.SDK.Benchmarks.Series
{
    ...
    public class GetByIndexBenchmark
    {
        ...
        //[Benchmark]
        //public void Chain_GetByIndex_Test()
        //{
        //    chelper.GetByIndex_From_Indexer_Test(collection, chain);
        //}

        //[Benchmark]
        //public void Catalog_GetByIndex_Test()
        //{
        //    chelper.GetByIndex_From_Indexer_Test(collection, catalog);
        //}

        [Benchmark]
        public void Listing_GetByIndex_Test()
        {
            chelper.GetByIndex_From_Indexer_Test(collection, listing);
        }

        [Benchmark]
        public void Registry_GetByIndex_Test()
        {
            chelper.GetByIndex_From_Indexer_Test(collection, registry);
        }

        [Benchmark]
        public void List_GetByIndex_Test()
        {
            dhelper.GetByIndex_Test(collection, list);
        }

        //[Benchmark]
        //public void Dictionary_GetByIndex_Test()
        //{
        //    dhelper.GetByIndex_Test(collection, (IDictionary<string, string>)dictionary);
        //}

        [Benchmark]
        public void OrderedDictionary_GetByIndex_Test()
        {
            dhelper.GetByIndex_Test(collection, ordereddictionary);
        }

        //[Benchmark]
        //public void ConcurrentDictionary_GetByIndex_Test()
        //{
        //    dhelper.GetByIndex_Test(collection, (IDictionary<string, string>)concurrentdictionary);
        //}
