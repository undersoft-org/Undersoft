...
namespace Undersoft.SDK.Benchmarks.Series
{
    ...
    public class SetByIndexBenchmark
    {
        ...
        {
            chelper.SetByIndex_Test(collection, listing);
        }

        [Benchmark]
        public void Registry_SetByIndex_Test()
        {
            chelper.SetByIndex_Test(collection, registry);
        }

        [Benchmark]
        public void List_SetByIndex_Test()
        {
            dhelper.SetByIndex_Test(collection, list);
        }

        //[Benchmark]
        //public void Dictionary_SetByIndex_Test()
        //{
        ...
        //{
        //    dhelper.SetByIndex_Test(collection, (IDictionary<string, string>)concurrentdictionary);
        //}
