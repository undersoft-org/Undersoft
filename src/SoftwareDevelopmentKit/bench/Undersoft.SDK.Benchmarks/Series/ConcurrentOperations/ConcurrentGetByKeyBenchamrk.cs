...
namespace Undersoft.SDK.Benchmarks.Series
{
    ...
    public class ConcurrentGetByKeyBenchmark
    {
        ...
        public ConcurrentGetByKeyBenchmark()
        {
            Setup();
        }
        ...
        [Benchmark]
        public Task Catalog_GetKey_Test()
        {
        ...
        [Benchmark]
        public Task Registry_GetKey_Test()
        {
            int limit = count / 10;
            return Task.Factory.ContinueWhenAll(
                tasks
        ...
        [Benchmark]
        public Task ConcurrentDictionary_GetKey_Test()
        {
            int limit = count / 10;
            return Task.Factory.ContinueWhenAll(
                tasks
