...
namespace Undersoft.SDK.Benchmarks.Series
{
    ...
    public class ConcurrentIterationBenchmark
    {
        ...
        public ConcurrentIterationBenchmark()
        {
            Setup();
        }
        ...
        [Benchmark]
        public Task Catalog_Itertion_Test()
        {
            int limit = count / 10;
        ...
        [Benchmark]
        public Task Registry_Itertion_Test()
        {
            int limit = count / 10;
            return Task.Factory.ContinueWhenAll(
                tasks
        ...
        [Benchmark]
        public Task ConcurrentDictionary_Itertion_Test()
        {
            int limit = count / 10;
            return Task.Factory.ContinueWhenAll(
                tasks
