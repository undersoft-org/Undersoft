...
namespace Undersoft.SSC.Service.Application.Server.Controllers
{
    ...
    public class AccountsController
        : CrudDataActionRemoteController<IDataStore, AccountAction, Account, Authorization>
    {
...
namespace Undersoft.SSC.Service.Application.Server.Controllers
{
    ...
    public class AccountController
       : OpenDataActionRemoteController<IDataStore, AccountAction, Account, Authorization>
    {
